...
@Component({
  selector: 'app-register-farmworker',
  templateUrl: './register-farmworker.component.html',
  styleUrls: ['./register-farmworker.component.scss']
})
export class RegisterFarmworkerComponent {
